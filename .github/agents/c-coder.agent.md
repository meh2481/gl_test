...
- Never use STL libraries or C standard libraries. They are compiled out. Use the templates in core/ or SDL3 wrappers instead.
- Do not use char* for strings. Use the string library in core/String.h instead.
- Do not use the cmath or SDL math library for trigonometric functions. Use the lookup table instead (see core/TrigLookup.h).
...
- Never prioritize backwards compatibility in the Lua interface or anywhere else. Break backwards compatibility whenever it makes the code better.
