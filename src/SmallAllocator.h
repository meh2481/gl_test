...
public:
    ...
    // Get statistics
    size_t getTotalMemory() const { return poolCapacity_; }
    size_t getUsedMemory() const { return poolUsed_; }
    size_t getFreeMemory() const { return poolUsed_ <= poolCapacity_ ? poolCapacity_ - poolUsed_ : 0; }
