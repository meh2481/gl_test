...
void LuaInterface::loadScene(uint64_t sceneId, const ResourceData& scriptData) {
    ...
    const char* actionConstants[] = {
        "ACTION_EXIT", "ACTION_MENU", "ACTION_PHYSICS_DEMO", "ACTION_AUDIO_TEST", "ACTION_ASPECT_TEST", "ACTION_TOGGLE_FULLSCREEN",
...
void LuaInterface::registerFunctions() {
    ...
    lua_pushinteger(luaState_, ACTION_ASPECT_TEST);
    lua_setglobal(luaState_, "ACTION_ASPECT_TEST");
